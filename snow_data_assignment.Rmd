...
ggplot(temp_yearly, aes(x = year, y = mean_temp, color=site)) +
  ...
  labs(x = "Year",
       y = "Average Temp (K)", 
       caption = "Figure 1: Lines of the graph represent a time series of average monthly temperature in Kelvin at the Swamp Angel Study Plot and the Senator Beck Study Plot.",
     color="Site") +
